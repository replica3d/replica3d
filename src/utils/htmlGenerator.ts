  ...
  for (const route of VALID_ROUTES) {
    ...
    try {
      ...
      $('head').empty()
        ...
        .append('<link rel="icon" type="image/png" href="/images/web-app-manifest-512x512.png" sizes="512x512">')
        .append('<link rel="icon" type="image/png" href="/images/web-app-manifest-192x192.png" sizes="192x192">')
