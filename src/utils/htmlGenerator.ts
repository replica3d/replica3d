...
const generateHtml = ($: cheerio.CheerioAPI, config: ReturnType<typeof getMetaConfig>): void => {
  $('head').empty()
    ...
    .append('<link rel="icon" type="image/svg+xml" href="/images/favicon.svg">')
    .append('<link rel="icon" type="image/png" href="/images/favicon-16x16.png" sizes="16x16">')
    .append('<link rel="icon" type="image/png" href="/images/favicon-32x32.png" sizes="32x32">')
    .append('<link rel="icon" type="image/png" href="/images/favicon-96x96.png" sizes="96x96">')
    .append('<link rel="icon" type="image/png" href="/images/android-chrome-192x192.png" sizes="192x192">')
    .append('<link rel="icon" type="image/png" href="/images/android-chrome-512x512.png" sizes="512x512">')
    .append('<link rel="apple-touch-icon" href="/images/apple-touch-icon.png">')
    .append('<link rel="manifest" href="/images/site.webmanifest">')
