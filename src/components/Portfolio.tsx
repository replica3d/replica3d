  ...
  return (
    <div id="portfolio" className="py-12 bg-white">
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          <p className="text-blue-600 text-sm font-semibold tracking-wider mb-2">NASZE NAJNOWSZE WYDRUKI 3D</p>
          <h2 className="text-[#333333] text-4xl md:text-5xl font-bold mb-4" aria-label="Zrealizowane projekty">zrealizowane projekty</h2>
